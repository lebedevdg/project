...
--google-open-port 9292/tcp --google-open-port 9090/tcp --google-open-port 8080/tcp --google-open-port 3000/tcp --google-open-port 8000/tcp --google-open-port 15672/tcp $name
